...
if __name__ == "__main__":
    bot = FinalFantasy()
    bot.abrir_navegador()
    bot.escribir_direccion("https://www.twitch.tv/ ")
    bot.buscar_direccion()
    time.sleep(6)
    bot.hacer_clic_en_imagen("assets/iniciar_sesion.png")
    time.sleep(6)
    pyautogui.write("rey222sss$",interval=0.2)
    time.sleep(6)
    pyautogui.press('tab')
    pyautogui.write("galletas100$",interval=0.2)
    time.sleep(6)
    bot.hacer_clic_en_imagen("assets/boton.png")
    time.sleep(4)
